...
CreateTierWeapons(0,"Enemy Sword","",800,0.5,0.07,"Melee","ARMORPEN",3500,5,5,"Slashing","WPN","Slashing","EvadeMelee","ico_enemysword.bmp",2,0,"NA",-1);
//=======================================
// PIERCING
...
CreateTierWeapons(0,"Enemy Knife","",440,0.5,0.07,"Melee","CRITCHANCE",100,10,15,"Piercing","WPN","Piercing","EvadeMelee","ico_enemyknife.bmp",1,0,"NA",-1);
...
CreateTierWeapons(0,"Enemy Trident","",500,0.6,0.07,"Melee","CRITDAMAGE",100,10,15,"Piercing","WPN","Piercing","EvadeMelee","ico_enemytrident.bmp",1,0,"NA",-1);
//=======================================
// BLUDGEONING
$WEAPONNAMES["Enemy Mace"] 	= "Basic Improved Fine Magic Rare Legendary";
$WEAPONVIS["Enemy Mace"] 	= "EMACE EMACE EMACE EMACE EMACE EMACE";
CreateTierWeapons(0,"Enemy Mace","",680,0.5,0.07,"Melee","MAXHP",1500,5,5,"Bludgeoning","WPN","Bludgeoning","EvadeMelee","ico_enemymace.bmp",2,0,"NA",-1);
//=======================================
// CROSSBOW
...
CreateTierWeapons(0,"Enemy Crossbow","",600,0.5,0.07,"Projectile","CRITDAMAGE",100,10,15,"Archery","WPN","Archery","Dodging","ico_enemycrossbow.bmp",2,1,"",2,"NA",-1);
//=======================================
// BOW
$WEAPONNAMES["Enemy Bow"] 	= "Basic Improved Fine Magic Rare Legendary";
$WEAPONVIS["Enemy Bow"] 	= "EBOW EBOW EBOW EBOW EBOW EBOW";
CreateTierWeapons(0,"Enemy Bow","",300,0.5,0.07,"Projectile","ARMORPEN",3500,5,5,"Archery","WPN","Archery","Dodging","ico_enemybow.bmp",1,2,"",2,"NA",-1);
//=======================================
// STAFF
...
CreateTierWeapons(0,"Enemy Staff","",599,0.5,0.07,"Spell","MAGICPEN",3500,5,5,"Focus","STF","Focus","SpellResist","ico_enemystaff.bmp",1,1,"NA",-1);
//=======================================
// WAND
$WEAPONNAMES["Enemy Wand"] 	= "Basic Improved Fine Magic Rare Legendary";
$WEAPONVIS["Enemy Wand"] 	= "EWAND EWAND EWAND EWAND EWAND EWAND";
CreateTierWeapons(0,"Enemy Wand","",544,0.5,0.07,"Spell","SPELLCRIT",100,10,15,"Focus","STF","Focus","SpellResist","ico_enemywand.bmp",1,0,"",3,"NA",-1);
...
CreateTierWeapons(1,"Hatchet","Smithing",800,0.3,0.3,"Melee","ARMORPEN",3500,5,5,"Slashing","WPN","Slashing","EvadeMelee","ico_hatchet.bmp",2,0,"",1);
CreateTierWeapons(1,"Broad Sword","Smithing",800,0.4,0.3,"Melee","ARMORPEN",3500,5,5,"Slashing","WPN","Slashing","EvadeMelee","ico_broadsword.bmp",2,0,"",2);
CreateTierWeapons(2,"War Axe","Smithing",800,0.5,0.3,"Melee","ARMORPEN",3500,5,5,"Slashing","WPN","Slashing","EvadeMelee","ico_waraxe.bmp",2,0,"",3);
CreateTierWeapons(2,"Long Sword","Smithing",800,0.6,0.3,"Melee","ARMORPEN",3500,5,5,"Slashing","WPN","Slashing","EvadeMelee","ico_longsword.bmp",2,0,"",4);
CreateTierWeapons(3,"Battle Axe","Smithing",800,0.7,0.3,"Melee","ARMORPEN",3500,5,5,"Slashing","WPN","Slashing","EvadeMelee","ico_battleaxe.bmp",2,0,"",5);
CreateTierWeapons(4,"Bastard Sword","Smithing",800,0.8,0.3,"Melee","ARMORPEN",3500,5,5,"Slashing","WPN","Slashing","EvadeMelee","ico_bastardsword.bmp",2,0,"",6);
CreateTierWeapons(5,"Halberd","Smithing",800,0.9,0.3,"Melee","ARMORPEN",3500,5,5,"Slashing","WPN","Slashing","EvadeMelee","ico_halberd.bmp",2,0,"",7);
CreateTierWeapons(6,"Claymore","Smithing",800,1.0,0.3,"Melee","ARMORPEN",3500,5,5,"Slashing","WPN","Slashing","EvadeMelee","ico_claymore.bmp",2,0,"",8);
