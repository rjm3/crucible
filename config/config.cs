...
bindAction(keyboard0, make, "numpad8", TO, IDACTION_LOOKUP, 0.099958);
bindAction(keyboard0, break, "numpad8", TO, IDACTION_LOOKUP, 0.000000);
bindAction(keyboard0, make, "numpad2", TO, IDACTION_LOOKDOWN, 0.099958);
bindAction(keyboard0, break, "numpad2", TO, IDACTION_LOOKDOWN, 0.000000);
bindAction(keyboard0, make, "numpad6", TO, IDACTION_TURNRIGHT, 0.099958);
bindAction(keyboard0, break, "numpad6", TO, IDACTION_TURNRIGHT, 0.000000);
bindAction(keyboard0, make, "numpad4", TO, IDACTION_TURNLEFT, 0.099958);
...
bindAction(mouse0, xaxis0, TO, IDACTION_YAW, Flip, Scale, 0.001278);
bindAction(mouse0, yaxis0, TO, IDACTION_PITCH, Flip, Scale, 0.001278);
